  ...
  data.forEach((details) => {
    ...
    div.innerHTML = `
     ...
     <div class="card card-compact bg-base-100 shadow-lg relative mt-2">
          ...
          <div class="absolute right-2 top-[192px] bg-[#343434] rounded max-w-xs -mt-5">
           <h4 class="text-[12px] px-1 text-center ${
             !postedDate ? "hidden" : ""
           } text-white" >${Time}</h4>
          </div>
          <div class="card-body">
            <div class="flex gap-4 justify-start items-center">
              <div class="avatar online">
                <div class="w-[50px] rounded-full">
                  <img
                    src="${details.authors[0].profile_picture}"
                  />
                </div>
              </div>
              <div>
            ...
            <div class="ml-16 pl-1 justify-center text-sm -mt-4">
              <h4 class="">
                ${details.authors[0].profile_name}
                  ${
                    details.authors[0].verified
                      ? `
                <svg
                  class="inline ml-1"
              ...
              <p>${details.others?.views} <span>views</span></p>
            </div>
          </div>
        </div>
     `;
